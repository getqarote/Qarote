...
/**
 * Pixel-art upward chevron. Mirror of PixelChevronDown flipped vertically.
...
export function PixelChevronUp({ className, ...props }: PixelChevronUpProps) {
  return (
    <svg
      ...
      {...props}
    >
      <rect x="0" y="106" width="53" height="53" fill="currentColor" />
      <rect x="53" y="53" width="53" height="53" fill="currentColor" />
      <rect x="106" y="0" width="53" height="53" fill="currentColor" />
      <rect x="159" y="53" width="53" height="53" fill="currentColor" />
      <rect x="212" y="106" width="53" height="53" fill="currentColor" />
    </svg>
  );
}
