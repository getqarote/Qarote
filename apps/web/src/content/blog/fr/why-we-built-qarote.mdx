...
**Un historique de file utilisable après incident.** La rétention native de RabbitMQ est courte et peu précise. Ce dont j'avais besoin cette nuit-là, c'était un graphique de profondeur à résolution 5 minutes sur 7 jours — quelque chose qui montre _exactement_ quand le backlog a commencé, pas seulement qu'il était actuellement large. Cette précision change la façon de scoper un incident : fuite lente ou chute soudaine ?
...
- **Minute 5 :** [Message Spy](/fr/features/message-spy/) a confirmé que les messages dans la file bloquée étaient structurellement valides — payload intact, en-têtes corrects. Les messages n'étaient pas le problème. Les consommateurs l'étaient.
- **Minute 5 :** Réduit à DB ou réseau. Correctif déployé à la minute 10.

Dix minutes, pas quarante.

Et le lendemain matin, le [Daily Digest](/fr/features/digest/) aurait inclus l'incident dans le résumé d'anomalies des 24 heures — toute l'équipe aurait été informée avant d'ouvrir Slack, sans que personne n'ait à écrire un email de rétrospective.

Si cette même file avait accumulé lentement pendant des jours avant l'incident — une fuite lente plutôt qu'une chute soudaine — l'[Historique de File](/fr/features/metrics/) l'aurait montré : des snapshots toutes les 5 minutes conservés 7 jours, traçables en regard du nombre de consommateurs et du taux de publication.
