...
> **Skip the Prometheus stack.** Qarote ships memory watermark alerting as a built-in rule with no scraper to configure. [See how alerting works →](/features/alerting/)
