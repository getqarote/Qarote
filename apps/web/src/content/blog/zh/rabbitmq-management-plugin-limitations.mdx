...
Qarote内置了这些告警类型——queue深度阈值、consumer数量下降、内存和磁盘告警、DLQ增长——并直接针对你的live broker数据进行评估，无需搭建Prometheus。[了解告警功能 →](/zh/features/alerting/)
...
[了解Qarote如何应对这些缺口 →](/zh/features/alerting/)
