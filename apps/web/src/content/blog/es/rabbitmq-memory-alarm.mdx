...
> **Sin el stack de Prometheus.** Qarote incluye alertas sobre el watermark de memoria como regla integrada, sin scraper que configurar. [Ver cómo funciona el sistema de alertas →](/es/features/alerting/)
