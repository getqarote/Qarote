...
// Lazy load FAQ to remove Accordion from critical rendering path
                ...
                {!isVideoPlaying ? (
                  <>
                    <picture>
                      <source
                        type="image/webp"
                        srcSet="/images/dashboard-640.webp 640w, /images/dashboard-1280.webp 1280w, /images/dashboard-1920.webp 1920w"
                        sizes="(max-width: 640px) 640px, (max-width: 1280px) 1280px, 1920px"
                      />
                      <img
                        src="/images/dashboard-optimized.png"
                ...
                <div className="pt-8 lg:pt-12 px-8 lg:px-12 pb-0 flex flex-col relative overflow-visible">
                  ...
                  <div className="space-y-5 mb-16">
                    ...
                    <div className="flex gap-4 items-start">
                      <CheckIcon className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <p className="text-foreground">
                        A unified dashboard for all your servers and
                        environments
                      </p>
                    </div>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground mb-4">
                        ...
                        Start monitoring your RabbitMQ infrastructure
                        immediately.
                      </p>
                    </div>
                  </div>
                    ...
                    >
                      <CardContent className="p-6 flex flex-col h-full">
                        <div className="text-left mb-2">
                          <h3
                            className={`text-2xl font-bold ${plan.color} mb-2`}
                          >
                            {plan.name}
                          </h3>
