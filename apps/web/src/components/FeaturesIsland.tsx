      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="order-1 lg:order-2 lg:sticky lg:top-24">
            ...
            <ul className="space-y-3">
              <FeaturePoint text="Read-only — messages are never consumed or acknowledged" />
              <FeaturePoint text="Full payload with JSON syntax highlighting" />
              <FeaturePoint text="Headers, routing key, delivery mode, redelivery status" />
            </ul>
            <a
              href="/features/message-spy/"
              className="group inline-flex items-center gap-1.5 text-sm font-medium text-primary mt-8 transition-all duration-150 hover:gap-2.5"
